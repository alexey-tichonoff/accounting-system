...
{
        public $levels = array(1 => 'Basic user', 2 => 'Independent user', 3 => 'Proficient user');
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, email, birthday, level', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'level' => 'Текущий уровень знания языка',
		);
	}
	...
	public static function model($className=__CLASS__)
	{
        ...
        protected function afterFind() {
           $date = date('d.m.Y', strtotime($this->birthday));
           $this->birthday = $date;
